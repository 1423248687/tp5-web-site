<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\A_Lance\tp5_dome\public/../application/admin\view\guestbook\initGuestbookList.html";i:1558063856;}*/ ?>
        ...
        <table class="list-table">
            ...
            <tr>
                ...
                <td style="text-align:center; border:1px solid #CCCCCC;">
                    <!--<a href="{ url('/Guestbook/initReadGuestbook/'<?php echo $bookList['id']; ?>; }">查看</a>-->
                </td>
            </tr>
