<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\A_Lance\tp5_dome\public/../application/admin\view\guestbook\initexportList.html";i:1558096096;}*/ ?>
...
<div class="highlight">
    <form name="searchform" action="<?php echo url('Guestbook/exportGuest'); ?>" method="get">
        ...
        <input type="text" class="date input-text  input-hover" size="21" id="totime" name="totime"
               value="<?php  echo (date('Y-m-d',$time).' 00:00:00'); ?>" readonly>&nbsp;
        <script language="javascript" type="text/javascript">
            date = new Date();
